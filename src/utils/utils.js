...
export const getAddress = async (callback, subAccountNumber) => {
  const authClient = await AuthClient.create();
  ...
  callback(principalToAccountIdentifier(authClient.getIdentity().getPrincipal().toText(), subAccountNumber));
};

export const getPrincipal = async (callback) => {
  const authClient = await AuthClient.create();
  ...
  callback(authClient.getIdentity().getPrincipal().toText());
};
